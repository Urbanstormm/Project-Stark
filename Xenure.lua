...
-- I was paid to repost this by this discord user: lolipop12311_25970 (1362575612144779395)
...
HubsTab:CreateButton({Name="JG Hub",Callback=function()loadstring(game:HttpGet("https://rscripts.net/script/jg-hub-brookhaven-UDaT"))()end}) loadstring(game:HttpGet("https://raw.githubusercontent.com/DontTrlp/chatgpt/refs/heads/main/testhub"))()
...
HubsTab:CreateButton({Name="FE Invisible Tool",Callback=function()loadstring(game:HttpGet("https://pastebin.com/raw/71bx8T3L"))()end})
-- Final Notification
Luna:Notification({
    Title = "Xenure Hub",
